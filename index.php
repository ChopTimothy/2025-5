...
<html lang="ru-RU">
  ...
  <body>
    ...
    <form action="sub.php" method="POST" id="form" class="w-50 mx-auto">
          ...
          <label >
            1) ФИО:<br>
            <input type="text" class="form-control <?php echo !empty($errors['name']) ? 'is-invalid' : ''; ?>" placeholder="Введите ФИО" name="name" id = "name" required
          ...
          <label ">
            2) Телефон:<br>
            <input class="form-control" type="tel" placeholder="+700000-00-00" name="phone" id="phone" required
          ...
          <label >
            3) e-mail:<br>
            <input class="form-control" type="email" placeholder="Введите почту" name="email" id="email" required
          ...
          <label >
            4) Дата рождения:<br>
            <input class="form-control" value="2005-01-1" type="date" name="birthdate" id="birthdate" required
          ...
          <div><br>
            5) Пол:<br>
          <label ><input type="radio" checked="checked" class="form-check-input" value="male" id="male" name="gender" required
                               <?php echo ($values['gender'] ?? '') === 'male' ? 'checked' : ''; ?>
                               class="<?php echo !empty($errors['gender']) ? 'is-invalid' : ''; ?>">
            Мужской</label>
          <label ><input type="radio" class="form-check-input" value="female" id="female" name="gender"
          ...
          <label >
            ...
            8):<br>
          <label ><input type="checkbox" class="form-check-input" name="agreement" id="agreement" value="1" required
